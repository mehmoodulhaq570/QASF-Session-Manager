...
const AuEnrollmentForm = () => {
  return (
    <div className="flex justify-center items-center min-h-screen bg-blue-50">
      <div className="bg-white rounded-lg shadow-md p-6 w-80">
        <h2 className="text-xl font-semibold text-center text-blue-600 mb-6">Enrollment for Author</h2>
        <form>
          <div className="mb-4">
            <label className="block text-sm font-medium text-gray-700 mb-1" htmlFor="organization-name">
              Please enter the link of your book?
            </label>
            <input
              type="url"
              id="book-link"
...
export default AuEnrollmentForm;
